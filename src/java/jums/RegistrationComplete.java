...
public class RegistrationComplete extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            /*registrationconfirm.jspで空白の有無を判別。
            入力フォームの情報をDB用に変換し、DBに格納*/

            Log.getInstance().LogWrite("RegistrationCompleteにアクセスしました。registrationcomplete.jspにアクセスします");
            ...
            UserDataDAO.getInstance().UserInsert(userdata);
            session.invalidate();
